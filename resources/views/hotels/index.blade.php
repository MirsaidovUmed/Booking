            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                    ...
                    <select name="category" id="category" class="mt-1 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                        ...
                        <option value="5-star" {{ request('category') == '5-star' ? 'selected' : '' }}>5-star</option>
                        <option value="4-star" {{ request('category') == '4-star' ? 'selected' : '' }}>4-star</option>
                        <option value="3-star" {{ request('category') == '3-star' ? 'selected' : '' }}>3-star</option>
