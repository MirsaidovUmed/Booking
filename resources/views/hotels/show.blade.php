...
<x-app-layout>
    <div class="py-14 px-4 md:px-6 2xl:px-20 2xl:container 2xl:mx-auto">
        ...
        @if($startDate && $endDate)
            <div class="mt-12">
                <h2 class="text-2xl font-bold mb-4">Доступные комнаты</h2>
            ...
            @if($hotel->reviews->isNotEmpty())
                @foreach($hotel->reviews as $review)
                    <div class="border-b py-4">
                        ...
                        <div class="mt-2 font-bold text-yellow-500">Отзыв: {{ $review->review}}</div>
                        <div class="mt-2 font-bold text-yellow-500">Рейтинг: {{ $review->rating }}/5</div>
                    </div>
                @endforeach
            @else
